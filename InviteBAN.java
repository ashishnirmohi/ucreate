...
public class InviteBAN {
	public WebDriver driver;
	 
	@BeforeTest
	public void launchbrowser() throws IOException {
		System.out.println("--------------Buyer Admin Normal Share Invite Testing----------------");
		...
		InviteBAN.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageBuyerAdminLoginCS() throws InterruptedException, Exception {
	...
	@Test (priority=1)
	public void community_StandardInvite() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteBAN.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteBAN.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("html/body/section/div[2]/div[1]/div/div/div[1]/div[2]/a"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteBAN.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteBAN.captureScreenShot(driver);
	    ...
	    invitebutTToN.click(); Thread.sleep(5000); InviteBAN.captureScreenShot(driver);
