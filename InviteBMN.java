...
public class InviteBMN {
	...
	public void launchbrowser() throws IOException {
		...
		InviteBMN.captureScreenShot(driver);
	}
	
	@Test (priority = 0)
	public void homepageBuyerMemberLogin() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ashishb1@mailinator.com"); Thread.sleep(2000);
	...
	@Test (priority=1)
	public void community_InviteFromBuyerMemberNormalShare() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteBMN.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteBMN.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("html/body/section/div[2]/div[1]/div/div/div[1]/div[2]/a"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteBMN.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteBMN.captureScreenShot(driver);
	    ...
	    invitebutTToN.click(); Thread.sleep(5000); InviteBMN.captureScreenShot(driver);
