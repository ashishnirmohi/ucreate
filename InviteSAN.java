...
public class InviteSAN {
	public WebDriver driver;
	 
	@BeforeTest
	public void launchbrowser() throws IOException {
		
		System.out.println("--------------Seller Admin Normal Share Invite Testing----------------");
		...
		InviteSAN.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageSellerAdminlogin() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ashishds01@mailinator.com"); Thread.sleep(2000);
	...
	@Test (priority=1)
	public void Community_InviteFromSellerAdmin() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteSAN.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteSAN.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("html/body/section/div[2]/div[1]/div/div/div[1]/div[2]/a"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteSAN.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteSAN.captureScreenShot(driver);
	    ...
	    invitebutTToN.click(); Thread.sleep(5000); InviteSAN.captureScreenShot(driver);
