...
public class InviteBMS {
	public WebDriver driver;
	 
	@BeforeTest
	public void launchbrowser() throws IOException {
		
		System.out.println("---------------Buyer Member Subcompany Share Testing--------------------------------");
		...
		InviteBMS.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageBuyerMemberSubcompanyShareLogin() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("qex9011@yopmail.com"); Thread.sleep(2000);
	...
	@Test (priority=1)
	public void community_InviteBuyerMemberSubcompanyShare() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteBMS.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteBMS.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("html/body/section/div[2]/div[1]/div/div/div[1]/div[2]/a"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteBMS.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteBMS.captureScreenShot(driver);
	    ...
	    invitebutTToN.click(); Thread.sleep(5000); InviteBMS.captureScreenShot(driver);
