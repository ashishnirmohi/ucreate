...
public class InviteSMN {
	public WebDriver driver;
	 
	@BeforeTest
	public void launchbrowser() throws IOException {
		
		System.out.println("------------------Seller Member Normal Share Testing-----------------------------");
		...
		InviteSMN.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageLoginSellerMember() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ashishbcom11@mailinator.com"); Thread.sleep(2000);
	...
	@Test (priority=1)
	public void community_InviteFromSellerMember() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteSMN.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteSMN.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("html/body/section/div[2]/div[1]/div/div/div[1]/div[2]/a"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteSMN.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteSMN.captureScreenShot(driver);
	    ...
	    invitebutTToN.click(); Thread.sleep(5000); InviteSMN.captureScreenShot(driver);
