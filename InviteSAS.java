...
public class InviteSAS {
	...
	public void launchbrowser() throws IOException {
		...
		InviteSAS.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageSellerAdminSubcompanyShareLogin() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ashishqao43@yopmail.com"); Thread.sleep(2000);
	...
	public void community_InviteSellerAdminSubcompanyShare() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteSAS.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteSAS.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("html/body/section/div[2]/div[1]/div/div/div[1]/div[2]/a"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteSAS.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteSAS.captureScreenShot(driver);
	    ...
	    invitebutTToN.click(); Thread.sleep(5000); InviteSAS.captureScreenShot(driver);
